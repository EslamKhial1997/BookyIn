...
exports.createFilterObject = (req, res, next) => {
  ...
  if (req.params.id)
    filterSubCategory = { category: req.params.id };
  req.filterObject = filterSubCategory;
  next();
};
 exports.createSubCategoryService = factory.createOne(SubCategoryModel);
exports.getAllSubCategoryService = expressAsyncHandler(async(req , res , next)=>{
const docs = await SubCategoryModel.find({category: req.params})
})
factory.getAll(SubCategoryModel);
